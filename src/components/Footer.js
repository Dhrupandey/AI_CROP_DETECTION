...
export default function Footer() {
  ...
  return (
    ...
    <div style={{position:"absolute",bottom:"28px",marginTop:"10px",height:"35px",width:"100%",backgroundColor:"#d1e0e0",color:"black",display:"flex",justifyContent:"center",alignItems:"center",zIndex:"11"}}> 
